...
public class Battleship {
    public static void main(String[] args) {
        ...
        while (!done) {
            menuOne = Helper.getNonZeroLenString(scan, "Choose: \na: Add Ship \nb: See Board \np: Play \nq: Quit Game");

            if (menuOne.equalsIgnoreCase("a")) {
                row = Helper.getInt(scan, "Enter a row you want your ship to be on:");
                col = Helper.getInt(scan, "Enter a column you want your ship to be on:");
                len = Helper.getRangedInt(scan, "Enter the length of your ship(3 or 4):", 3, 4);
                horizontal = Helper.getYNConfirm(scan, "Enter Y if you want your ship to be horizontal, enter N if you want your ship to be vertical:");
        ...
        while (!doneTwo) {
            menuTwo = Helper.getNonZeroLenString(scan, "Choose: \ns: Shoot \nb: See Board \nq: Quit Game");

            if (menuTwo.equalsIgnoreCase("s")) {
                row = Helper.getInt(scan, "Enter a row you want your shot to be in:");
                col = Helper.getInt(scan, "Enter a column you want your shot to be in:");
